                ...
                <table class="table">
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            ...
                            <asp:Button ID="Button3" runat="server" BackColor="#366F9B" BorderColor="#366F9B" CausesValidation="False" Font-Bold="False" Font-Size="20px" ForeColor="White" Height="35px" OnClick="Button3_Click" Text="Button" Width="100px" />
                        </td>
                    </tr>
                </table>
